...
export const ui = {
  en: {
    ...
    registerCalStringDescription: 'This string must match the name of your calendar entries in the heating control calendar!',
    ...
    registerDisclaimer: 'Use the correct Nextcloud string for your account, this must match the calendar entry name in the Heating Control Nextcloud calendar. This is used to connect your settings with the Nextcloud calendar. Each calendar entry must start with this string.',
    roomName: 'Room Name',
  ...
  de: {
    ...
    password: 'Passwort',
    registerCalString: 'Nextcloud-String',
    registerCalStringDescription: "Dieser String muss dem Namen deiner Kalendereinträge im Heizungssteuerungs-Kalender entsprechen!",
    ...
    calString:'Kalendar-String',
    calStringDescription: 'Hier kann der Text angepasst werden, welche für die Kalendar-Events von Nextcloud benötigt wird.',
    ...
    registerDisclaimer: 'Verwenden Sie den korrekten Nextcloud-String für Ihren Account, dieser muss dem Kalendereintrag-Namen im Heizungssteuerungs Nextcloud-Kalender entsprechen. Dieser wird verwendet, um Ihren Einstellungen mit dem Nextcloud-Kalender zu verbinden. Jeder Kalendereintrag muss mit diesem String beginnen.',
    roomName: 'Raumname',
