...
export const ui = {
  en: {
    ...
    registerDisclaimer: 'Use the same name for your account and Nextcloud abbreviation. This will be used to connect your account to the Nextcloud calendar',
    roomName: 'Room Name',
  ...
  de: {
    ...
    registerDisclaimer: 'Verwenden Sie den gleichen Namen für Ihren Account und Nextcloud-Kürzel. Dieser wird verwendet, um Ihren Account mit dem Nextcloud-Kalender zu verbinden.',
    roomName: 'Raumname',
