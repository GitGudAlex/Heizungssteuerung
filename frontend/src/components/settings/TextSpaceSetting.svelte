...
>
  ...
  <ButtonGroup>
    <Button size="lg" outline checked={$lineHeight === 1} color="dark" on:click={updateLineHeight}>1.0</Button>
    <Button size="lg" outline checked={$lineHeight === 1.5} color="dark" on:click={updateLineHeight}>1.5</Button>
    <Button size="lg" outline checked={$lineHeight === 2} color="dark" on:click={updateLineHeight}>2.0</Button>
    <Button size="lg" outline checked={$lineHeight === 2.5} color="dark" on:click={updateLineHeight}>2.5</Button>
    <Button size="lg" outline checked={$lineHeight === 3} color="dark" on:click={updateLineHeight}>3.0</Button>
  </ButtonGroup>
...
<style>
  ...
  .setting-description {
    flex: 2;
    margin: 0.5em 1.5em 0.5em 0; /* top right bottom left */
